...
contract Account is DebtService, SwapService {
    ...
    // Events
    event Short(uint256 cAmt, uint256 dAmt);
     ...
     */
    function short(uint256 _cAmt, uint256 _ltv, uint256 _swapAmtOutMin) public payable {
        ...
        _swapExactInput(dToken, bToken, dAmt, _swapAmtOutMin);

        // 4. Emit event
        emit Short(_cAmt, dAmt);
    }
}
